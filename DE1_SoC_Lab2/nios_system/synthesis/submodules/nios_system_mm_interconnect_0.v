...
module nios_system_mm_interconnect_0 (
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> pushbuttons_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pushbuttons_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // pushbuttons_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pushbuttons_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> pushbuttons_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> pushbuttons_s1_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> hex_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // hex_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> hex_s1_agent:cp_channel
	...
	wire  [92:0] pushbuttons_s1_agent_rp_data;                                                       // pushbuttons_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [92:0] hex_s1_agent_rp_data;                                                               // hex_s1_agent:rp_data -> router_006:sink_data
	...
	wire         pushbuttons_s1_agent_rdata_fifo_src_valid;                                          // pushbuttons_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pushbuttons_s1_agent_rdata_fifo_src_data;                                           // pushbuttons_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pushbuttons_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_003:in_0_ready -> pushbuttons_s1_agent:rdata_fifo_src_ready
